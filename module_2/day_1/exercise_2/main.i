...
# 283 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/_stdlib.h" 2 3 4
...
# 284 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/_stdlib.h" 2 3 4
...
int main(int argc, char *argv[])
{
    if (argc != 2)
    {
        fprintf(__stderrp, "Usage: %s <32-bit hex value>\n", argv[0]);
        return 1;
    }
    ...
    if (*endptr != '\0')
    {
        fprintf(__stderrp, "Invalid hexadecimal input.\n");
        return 1;
    }
